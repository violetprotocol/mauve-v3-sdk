...
describe('Pool', () => {
  ...
  describe('constructor', () => {
    ...
    it('works with valid arguments for empty pool lower fee', () => {
      new Pool(USDC, WETH9[1], FeeAmount.LOWER, encodeSqrtRatioX96(1, 1), 0, 0, [])
    })
  ...
  describe('#getAddress', () => {
    it('matches an example', () => {
      ...
      expect(result).toEqual('0xC5caCB3C3875e7D61D7b661Ec9D2f329d9255bb2')
    })
  })
